...
class Emerald extends AdditionalItem{
	public function onInteractBlock(Player $player, Block $blockReplace, Block $blockClicked, int $face, Vector3 $clickVector) : ItemUseResult{
		...
		$player->getEffects()->add(new EffectInstance(VanillaEffects::SPEED(), 10 * 20, 1, false));
		$userHandler->sendTranslatedMessage($player, "item.use.emerald", MESSAGE);
		$this->pop();
